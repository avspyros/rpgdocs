...
Any Magic-User can create a spell scroll for any spell in they spellbook. The process costs 50 sp per day. Even though the scroll is essentially a “one-use” formula for a spell, each must still be
...
If a Magic-User finds a spell scroll containing a spell not already in the Magic-User’s spellbook, they can instead transcribe the spell on the scroll into they spellbook. This will remove the spell
...
A Magic-User can research spells of a higher level than they are able to cast and add them to they spellbook, but they may never prepare such spells. They can, however, write them on scrolls.

A player can invent totally new spells for they character to research. The player must first write the spell in the format of the other spells in the spell lists. The GM must approve the spell, and
