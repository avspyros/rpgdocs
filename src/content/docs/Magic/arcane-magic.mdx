...
transcribe. When they gain access to a new spell level, they can add a new specialization spell for that level. Magic-Users can prepare spells according to the Magic-User table, plus one extra
specialization spell from any level. Elves, however, begin only with Read Magic and gain one spell each level.
