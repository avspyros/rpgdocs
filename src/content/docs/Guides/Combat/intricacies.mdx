...
2. Each adds their movement rate divided by 10 to the roll. Example: A character with a movement rate of 120' adds +12
   to their roll.
...
- If the defender is armed and hasn't acted this round, they get a free attack against the aggressor before the
  wrestling attempt.

- Both parties roll 1d20 + their melee Attack Bonus + Strength modifier. Ties are decided by Dexterity modifier or a
  further die roll.

Outcomes (winner chooses):

- Immobilize: Loser is held and can only attempt to escape or make minimal attacks with natural or small weapons. After
  3 failed escapes, the loser is pinned and helpless.
