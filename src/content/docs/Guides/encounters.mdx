...
- The chart can also be used when someone is attempting to convince an NPC as to a course of action and there is doubt
  as to the outcome.
...
- To make a Morale check, roll 2d6; if the roll is equal to or less than the their Morale score, they are willing to
  stand and fight.
